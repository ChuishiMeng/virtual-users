...
\toprule
Method & Dist. Sim. $\uparrow$ & KL Div. $\downarrow$ & Kappa $\uparrow$ & ACS $\uparrow$ & Jaccard $\uparrow$ & Exact Match $\uparrow$ \\
\midrule
...
\textbf{ConsistAgent (Ours)} & \textbf{0.957} & \textbf{1.644} & \textbf{-0.313} & \textbf{0.833} & \textbf{0.912} & \textbf{0.201} \\
\bottomrule
\end{tabular}
\end{table}
