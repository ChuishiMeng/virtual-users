...
\bibitem{chen2025polypersona}
Chen, Y., et al. (2025). Polypersona: Persona-Grounded LLM for Synthetic Survey Responses. arXiv:2512.14562.

\bibitem{wang2025large}
Wang, L., et al. (2025). Large Language Models as Virtual Survey Respondents. arXiv:2509.06337.

\bibitem{zhang2025llm}
Zhang, H., et al. (2025). LLM-S³: Synthetic Survey Simulation with LLMs. arXiv:2509.06337.

\bibitem{liu2025alignsurvey}
Liu, X., et al. (2025). AlignSurvey: A Comprehensive Benchmark for Human Preferences Alignment. arXiv:2511.07871.

\bibitem{abdulhai2025measuring}
Abdulhai, A., et al. (2025). Measuring Consistency in LLM Dialogue Systems. NeurIPS 2025.

\bibitem{zhang2026humanstudy}
Zhang, Y., et al. (2026). HumanStudy-Bench: Towards AI Agent Design for Participant Simulation. arXiv:2602.00685.
